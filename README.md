...
See [`testnets/cardano_node_governance/README.md`](testnets/cardano_node_governance/README.md) for topology and validation steps, and [`testnets/cardano_node_governance/PROPERTIES.md`](testnets/cardano_node_governance/PROPERTIES.md) for every assertion the drivers emit.
